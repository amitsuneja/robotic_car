    // https://blog.zedfox.us/draw-moving-vehicles-polygons-real-time-google-maps/ 
    var myMap;
    ...
    function initialize() {
        ...
        myMap = new google.maps.Map( 
            document.getElementById('googleMapDivId'), 
            mapOptions
        );
    ...
    function createSelectionControl() {
        var dd = document.getElementById('drawAgainDivId');
